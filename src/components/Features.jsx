...
// Features.jsx
import React from "react";
import { BsRocketTakeoff, BsPeople, BsBarChart } from "react-icons/bs";
import AOS from "aos";
...
const features = [
  {
    ...
    description: "Practical projects and mentorship to kickstart your tech journey.",
    aos: "fade-up",
  },
  {
    icon: <BsPeople size={32} />,
    title: "Learn With Peers",
    description: "Join a community of learners and grow together in a collaborative space.",
    aos: "fade-up",
  },
  {
    icon: <BsBarChart size={32} />,
    title: "Track Your Progress",
    description: "Visualize your learning progress with our smart roadmap system.",
    aos: "fade-up",
  },
];
  ...
  return (
    <section className="py-5 bg-light" id="features">
      <div className="container text-center">
        <h2 className="fw-bold mb-3">What Makes SkillPilot Special?</h2>
        <p className="text-muted mb-5">
          Explore the features designed to empower your learning journey.
        </p>
        ...
        <div className="row">
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-white p-4 h-100 shadow-sm rounded">
